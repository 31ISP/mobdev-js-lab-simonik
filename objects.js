...
const students = [
 ...
 const passedNames = students.filter(student => student.passed).map(student => student.name);
 console.log("Сдавшие:", passedNames);

 const topStudent = students.find(student => student.grade > 4.5);
 console.log("Студент с оценкой отлично:", topStudent);
